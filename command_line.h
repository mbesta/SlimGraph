...
class CLBase {
 protected:
  ...
  std::string name_;
  // Slimgraph change
  std::string get_args_ = "f:g:hk:o:p:su:V:";
  // End of Slimgraph change
  std::vector<std::string> help_strings_;

  // Slimgraph change
  std::string output_filename_ = "";
  double sampling_propability_ = 0.0;
  std::string spectral_variant_ = "";
  // End of Slimgraph change
 ...
 public:
  CLBase(int argc, char** argv, std::string name = "") :
    ...
    // Slimgraph change
    AddHelpLine('o', "file", "output file name");
    AddHelpLine('p', "prop", "edge sampling probability", "1.0");
    AddHelpLine('V', "variant", "variant of spectral sparsification (avg/log)");
    // End of Slimgraph change
  ...
  void virtual HandleArg(signed char opt, char* opt_arg) {
    switch (opt) {
      ...
      case 'p': sampling_propability_ = atof(opt_arg);      break;
      case 'V': spectral_variant_ = std::string(opt_arg);   break;
      // End of Slimgraph change
  ...
  double sampling_propability() const { return sampling_propability_; }
  std::string spectral_variant() const { return spectral_variant_; }
  // End of Slimgraph change
